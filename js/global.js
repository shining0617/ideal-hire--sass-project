window.onload=function(){
    ...
    var workingClock = jQuery('.workingTimer').FlipClock({ 
            clockFace: 'HourlyCounter',
            autoStart: false,
            lang: false,  
            language: 'chinese' 
        });    
    workingClock.setTime(44400);
    workingClock.setCountdown(true);
    workingClock.start();
    jQuery('.workingTimer').parents(".workIng").find(".workingStop").each(function(){
        jQuery(this).click(function(){
            workingClock.stop(); 
    ...
    jQuery('.workingTimer').parents(".workIng").find(".workingStart").each(function(){ 
        jQuery(this).click(function(){
            workingClock.start();
    ...
    jQuery(".delTask").click(function(){
        jQuery(this).parent().addClass("removeUp");    
        setTimeout(function(){
